...
struct Layer {
    ...
    std::vector<std::shared_ptr<mkyu::Object>> const& objects() const {
        return m_objects;
    }
...
protected:
    ...
    void add_object(std::shared_ptr<mkyu::Object> const&);
private:
    std::vector<std::shared_ptr<mkyu::Object>> m_objects;
